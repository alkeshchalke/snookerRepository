...
public class UpdateSinglesFrameCompletionDetailsAction extends ActionSupport
        implements TestProjectConstantsIfc, ServletRequestAware
{
    /**
     * 
     */
    private static final long serialVersionUID = 6730716458839387252L;
    ...
    public String execute() throws Exception
    {
        ...
        logTimeServiceImplObj.updateCustomerPaymentDetails(custEntryNo, 0, paymentAmount, 0);

        // Update payment amount in Customer table.
        customerServiceImplObj.updateCustomerBill(payingPlayer, 0, paymentAmount, 0);
        ...
        if (isCustomerOutTimeUpdated && isCustomerCurrentlyPlaying && isMatchPayeeUpdated)
        {
