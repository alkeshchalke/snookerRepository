...
<s:form action="/DistributeAmountInAllPlayersAction.action"
						...
						<s:iterator value="finishMatchDTO">
							<td align="center" style="width: 100%">
								<table style="width: 100% border: 1 align: center">
									...
									<tr>
										<td height="20" width="20%" class="tableheadrow">
											<!-- <div align="right" class="tab">Winning Player:
												&nbsp;&nbsp;</div> -->
										</td>
										<td height="20" width="30%" class="normal">&nbsp;&nbsp;
										<%-- <s:select id="winningPlayer" name="winningPlayer" headerKey="-1" headerValue="Winning Player"
													list="selectPayeeList" theme="simple" /> --%>
										</td>
										<td height="20" width="20%" class="tableheadrow">
										...
										<td height="20" width="30%" class="normal">&nbsp;&nbsp;<s:property
												value="paymentAmount" /><s:hidden name="paymentAmount" value="%{paymentAmount}" />
										<%-- <s:textfield
