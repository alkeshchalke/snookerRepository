...
<script>
	function markThePlayer() {
		...
		callAction('DistributeAmountInAllPlayersAction.action?markedPlayer='+playertoUpdate);
	}
</script>
...
<s:form action="/UpdateRummyFrameCompletionDetailsAction.action"
	...
	<table style="width: 100%">
		<tr>
			<td class="fieldname">Rummy Match Player Contributions</td>
		</tr>
		<tr bgcolor="#CCCCCC">
			<td></td>
		</tr>
							...
							<table style="width: 100% border: 1 align: center">
								...
								<tr>
									<td height="20" width="20%" colspan="4" class="tableheadrow">
										<div align="center" class="tab">Loosing Player's
											Contribution: &nbsp;&nbsp;</div>
									</td>
								</tr>
								<tr height="10" />
								<s:if test="%{loosingPlayer1Amount != 0}">
								<tr>
										<td height="20" width="20%">
												<div align="right" class="tab">
													<span style='font-family: Arial;'>&#8377;</span>&nbsp;
													<s:property value="loosingPlayer1Amount" />
												</div>
											</td>
											<td height="20" width="30%" class="normal">&nbsp;&nbsp;
												<s:property value="loosingPlayer1" />
											</td>
											<td height="20" width="20%" >
											<% if(i == 0){%><s:select list="payingPlayersList"
										...
										<td height="20" width="20%">
											...
											<td height="20" width="20%" ><% if(i == 1){%> <s:select list="payingPlayersList"
													headerKey="-1" headerValue="Select a Player"
													name="markedPlayer2" theme="simple" id="markedPlayer2">
												</s:select> <%}%></td>
											<td height="20" width="30%" class="normal"><% if(i == 1){%> <input type="button" id="confirmButton"
												value="<s:text name="button.confirm" />"
												onclick="markThePlayer()" /> <%}%></td>
										</tr>
									 </s:if>
									...
									<s:if test="%{loosingPlayer3Amount != 0}">
										<tr>
											...
											<td height="20" width="20%" ><% if(i == 2){%> <s:select list="payingPlayersList"
													headerKey="-1" headerValue="Select a Player"
													name="markedPlayer3" theme="simple" id="markedPlayer3">
												</s:select>
												<%}%></td>
											<td height="20" width="30%" class="normal"><% if(i == 2){%> <input type="button" id="confirmButton"
												value="<s:text name="button.confirm" />"
												onclick="markThePlayer()" /> <%}%></td>
										</tr>
									</s:if>
									...
									<s:if test="%{loosingPlayer4Amount != 0}">
										<tr>
											...
											<td height="20" width="20%" ><% if(i == 3){%> <s:select list="payingPlayersList"
													headerKey="-1" headerValue="Select a Player"
													name="markedPlayer4" theme="simple" id="markedPlayer4">
												</s:select>
												<%}%></td>
											<td height="20" width="30%" class="normal"><% if(i == 3){%> <input type="button" id="confirmButton"
												value="<s:text name="button.confirm" />"
												onclick="markThePlayer()" /> <%}%></td>
										</tr>
									</s:if>
									...
									<s:if test="%{loosingPlayer5Amount != 0}">
										<tr>
											...
											<td height="20" width="20%" ><% if(i == 4){%> <s:select list="payingPlayersList"
													headerKey="-1" headerValue="Select a Player"
													name="markedPlayer5" theme="simple" id="markedPlayer5">
												</s:select>
												<%}%></td>
											<td height="20" width="30%" class="normal"><% if(i == 4){%> <input type="button" id="confirmButton"
												value="<s:text name="button.confirm" />"
												onclick="markThePlayer()" /> <%}%></td>
										</tr>
									</s:if>
									...
									<s:if test="%{loosingPlayer6Amount != 0}">
										<tr>
											...
											<td height="20" width="20%" ><% if(i == 5){%> <s:select list="payingPlayersList"
													headerKey="-1" headerValue="Select a Player"
													name="markedPlayer6" theme="simple" id="markedPlayer6">
												</s:select>
												<%}%></td>
											<td height="20" width="30%" class="normal"><% if(i == 5){%> <input type="button" id="confirmButton"
												value="<s:text name="button.confirm" />"
												onclick="markThePlayer()" /> <%}%></td>
										</tr>
									</s:if>
								...
								<s:iterator value="paymentContributorsMap" status="stat">
									<s:iterator>
										<tr>
											<td height="20" width="20%">
											...
											<td height="20" width="20%">&nbsp;&nbsp;
												<s:property value="value"/></td>
											<td height="20" width="30%" class="normal"></td>
										</tr>
									</s:iterator>
								</s:iterator>
								...
								<tr>
									<td colspan="2" height="20" width="50%" class="normal"
										align="right"><input type="button" id="cancelButton"
										value="<s:text name="button.cancelMatch" />"
										onclick="cancelButtonClicked()" /></td>
									<td colspan="2" height="20" width="50%" class="normal"
										align="left">
										<button type="submit">
