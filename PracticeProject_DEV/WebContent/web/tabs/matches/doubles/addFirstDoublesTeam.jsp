...
<s:form action="/AddSecondDoublesTeamAction.action" method="post"
	theme="simple" name="companyForm" onsubmit="return(validate());">

	<table style="width: 100%">
		<tr>
			<td class="fieldname">Add First Doubles team Details</td>
		</tr>
		<tr bgcolor="#CCCCCC">
			<td></td>
		</tr>
							...
							<td align="center" style="width: 100% border: 1">
								<table style="width: 100% border: 1 align: center">
									...
									<tr>
										...
										<td height="20" width="30%" class="normal"><s:property
												value="selectedTableNo" /> <s:hidden
												name="selectedTableNo" value="%{selectedTableNo}" /></td>
										<td height="20" width="47%" class="fieldname"></td>
									</tr>
									<tr height="15" />
									...
									<tr>
										...
										<td height="50" width="30%" class="normal"><s:property
												value="player1" /> <s:select list="selectPlayerList"
												headerKey="-1" headerValue="Select Player 1" name="player1"
												theme="simple" id="player1"
												onchange="updateNextDropdown(this.value)"></s:select></td>
										<td height="20" width="47%" class="fieldname"></td>
									</tr>
									<tr height="15" />
									...
									<tr>
										...
										<td height="50" width="30%" class="normal"><s:property
												value="player1" /> <s:property value="player2" /> <s:select
