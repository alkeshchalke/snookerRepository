...
<s:form action="/EditSelectedCustomerAction.action" method="post"
	theme="simple" name="searchCustomerForm" onsubmit="return(validate());">

	<table width="100%">
		<tr>
			<td width="100%" class="fieldname">List of all Customers</td>
		</tr>
		<tr bgcolor="#CCCCCC">
			<td></td>
		</tr>
				...
				<table style="width: 100%" class="tableoutline">
					...
					<tr>
						...
						<td height="20" width="10%"><s:select
								...
								name="customerName" theme="simple"></s:select></td>
...
<script>
	...
	document.getElementById("editCustomerTab").style.backgroundColor = "#A9A9F5";
</script>
